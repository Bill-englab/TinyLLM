...
本仓库按 **8 篇 47 讲课程**组织学习(理论 + 本机实践 + 面试自测,约 115 小时):
...
| 3 | 量化技术体系 | ⏳ |
| 4 | Kernel 与编译优化 | ⏳ |
| 5 | 训练与模型适配(SFT/QLoRA/蒸馏) | ⏳ |
| 6 | 服务化与生产部署 | ⏳ |
| 7 | 分布式与前沿 + 毕业项目 | ⏳ |

- 📖 **[课件中心](docs/course/index.html)**:双击打开,一章一章学(第 0/1 篇课件已备,滚动更新)
- 🖥️ **[课程进度台](docs/dashboard.html)**:逐讲勾选,自动定位当前位置,与课件同步
- 📚 **[课程大纲](docs/plans/课程大纲.md)**:教学主文档(每讲理论/实践/产出/自测 + 面试速查)
- 🗺️ [学习路线图](docs/plans/学习路线图.md):篇↔阶段↔代码目录映射
- 📊 [PROGRESS](docs/progress/PROGRESS.md):篇级权威进度
